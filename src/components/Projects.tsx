...
const projects = [
  {
    ...
    description: "Repositorio con ejercicios de programación de la plataforma CodeWars resueltos en Java. Una colección de soluciones a diversos desafíos algorítmicos.",
  ...
  },
  {
    ...
    description: "Sitio web oficial para el Ayuntamiento de Binissalem. Portal turístico desarrollado con WordPress y PHP para promover el municipio.",
